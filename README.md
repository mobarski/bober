...
Inspired by [ralph](https://github.com/snarktank/ralph) and [autoresearch](https://github.com/karpathy/autoresearch). Docs: [DeepWiki](https://deepwiki.com/mobarski/bober).
